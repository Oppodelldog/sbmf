...
func TestPrimitiveLists(t *testing.T) {
	foo := PrimitiveLists{
		...
		F32:  []float32{float32Min, 0, 0.6, 0.7, 0.8, 0.9, 1.0, math.MaxFloat32},
		F64:  []float64{float64Min, 0, 0.6, 0.7, 0.8, 0.9, 1.0, math.MaxFloat64},
...
func getFoobarFixture() Foobar {
	return Foobar{
		...
		PL: PrimitiveLists{
			I32: []int32{math.MinInt32, 0, math.MaxInt32},
			I64: []int64{math.MinInt64, 0, math.MaxInt64},
			F32: []float32{float32Min, 0, 0.678912345, 0.77, 0.88, 0.99, 1.1, math.MaxFloat32},
			F64: []float64{float64Min, 0, 0.678912345, 0.77, 0.88, 0.99, 1.1, math.MaxFloat64},
			S:   []string{"hello", "world"},
			B:   []bool{true, false},
		},
	}
...
func TestCrossLanguagePrimitiveLists(t *testing.T) {
	...
	assertSlicesEqual(t, pl.F32, []float32{float32Min, 0, 0.11, 0.22, 0.33, 0.44, 0.55, math.MaxFloat32})
